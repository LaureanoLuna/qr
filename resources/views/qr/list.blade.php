        ...
        <div class="grid grid-cols-2">
            ...
            <div style="display: grid;gap: 5px; text-transform: uppercase; height:100px;width: 100px; margin-left: 10px; margin-right: 20px;">
                <a href="route('qr.create')" style="border: solid 1px #a3a3a3; border-radius: 5px; background-color: transparent; color: yellow;text-align: center; align-content: center; text-transform: uppercase; cursor:not-allowed; pointer-events: none;">
                    <svg style="width: 25px; margin: auto;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            ...
            <div style="display: grid;gap: 5px; text-transform: uppercase; height:100px;width: 100px; margin-left: 10px; margin-right: 20px;">
                <a href="route('qr.create')" style="border: solid 1px yellow; border-radius: 5px; background-color: transparent; color: yellow;text-align: center; align-content: center; text-transform: uppercase; ">
                    <svg style="width: 25px; margin: auto;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
